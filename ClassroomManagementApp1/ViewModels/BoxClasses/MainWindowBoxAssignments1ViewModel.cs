...
{
    public class MainWindowBoxAssignments1ViewModel : ViewModelBase
    {
        ...
        public MainWindowBoxAssignments1ViewModel(ClassesService classService, AssignmentService assignmentService)
        {
        ...
        public MainWindowBoxAssignments1ViewModel() : this(CreateDbContext().Item1, CreateDbContext().Item2)
        {
        }
