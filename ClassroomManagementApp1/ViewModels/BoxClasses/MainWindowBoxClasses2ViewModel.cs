...
{
    public class MainWindowBoxClasses2ViewModel : ViewModelBase
    {
        ...
        public MainWindowBoxClasses2ViewModel(ClassesService classService, AssignmentService assignmentService)
        {
        ...
        public MainWindowBoxClasses2ViewModel() : this(CreateDbContext().Item1, CreateDbContext().Item2)
        {
        }
        private async void InitializeData()
        {
            try
            {
                ...
                var dateBegin = ClassList[2].datebegin.ToString("dd/MM/yyyy");
                var dateEnd = ClassList[2].dateend.ToString("dd/MM/yyyy");
                Item = new MainWindowBoxClassesItem(ClassList[2].Subject.subjectname, ClassList[2].Teacher.teacherid, dateBegin, dateEnd);
