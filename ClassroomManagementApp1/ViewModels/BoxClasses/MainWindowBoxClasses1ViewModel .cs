...
{
    public class MainWindowBoxClasses1ViewModel : ViewModelBase
    {
        ...
        public MainWindowBoxClasses1ViewModel(ClassesService classService, AssignmentService assignmentService)
        {
        ...
        public MainWindowBoxClasses1ViewModel() : this(CreateDbContext().Item1, CreateDbContext().Item2)
        {
        }
        private async void InitializeData()
        {
            try
            {
                ...
                var dateBegin = ClassList[1].datebegin.ToString("dd/MM/yyyy");
                var dateEnd = ClassList[1].dateend.ToString("dd/MM/yyyy");
                Item = new MainWindowBoxClassesItem(ClassList[1].Subject.subjectname, ClassList[1].Teacher.teacherid, dateBegin, dateEnd);
