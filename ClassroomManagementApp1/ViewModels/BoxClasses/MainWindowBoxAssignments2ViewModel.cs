...
{
    public class MainWindowBoxAssignments2ViewModel : ViewModelBase
    {
        ...
        public MainWindowBoxAssignments2ViewModel(ClassesService classService, AssignmentService assignmentService)
        {
        ...
        public MainWindowBoxAssignments2ViewModel() : this(CreateDbContext().Item1, CreateDbContext().Item2)
        {
        }
