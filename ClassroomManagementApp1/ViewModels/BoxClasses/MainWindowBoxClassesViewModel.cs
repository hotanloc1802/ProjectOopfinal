...
namespace ClassroomManagementApp1.ViewModels.BoxClasses
{
    public class MainWindowBoxClassesViewModel : ViewModelBase
    {
        ...
        public Tuple<DateTime, DateTime> DateRange
        {
            ...
            {
                _dateRange = value;
                // Thông báo rằng thuộc tính đã thay đổi (nếu bạn sử dụng INotifyPropertyChanged)
        ...
        private async void InitializeData()
        {
            try
            {
                ...
                SetDateRange(ClassList[0].datebegin, ClassList[0].dateend);
        ...
        {
            DateRange = new Tuple<DateTime, DateTime>(startDate, endDate);
        }
